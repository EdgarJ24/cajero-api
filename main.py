#Correr la api: uvicorn main:api --reload
...
origins = [
    ...
    "http://localhost", "http://localhost:8080", "https://ej-cajero-app.herokuapp.com/"
]
api.add_middleware(
...
async def get_balance(username: str):
    ...
    if user_in_db == None:
        raise HTTPException(status_code=404,
                            detail="El usuario no existe")
    '''
        Hacer un mapeo entre las claves-valor definidas en la salida con respecto a los campos de la entrada
        En UserInDB hay 3 campos del diccionario, en UserOut sólo hay dos campos
        Con ** Se hace el mapeo con los campos definidos en UserOut
    '''
